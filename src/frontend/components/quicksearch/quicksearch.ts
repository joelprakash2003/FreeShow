...
const faq = [
    // Docs About
    { id: "https://presenterbuddy.app/docs/projects", name: "About Projects", icon: "help" },
    { id: "https://presenterbuddy.app/docs/show-type", name: "About Shows", icon: "help" },
    { id: "https://presenterbuddy.app/docs/overlays", name: "About Overlays", icon: "help" },
    { id: "https://presenterbuddy.app/docs/templates", name: "About Templates", icon: "help" },
    { id: "https://presenterbuddy.app/docs/outputs", name: "Multiple Outputs", icon: "help", aliases: ["-Livestream", "-OBS"] },
    // Docs Help
    { id: "https://presenterbuddy.app/docs/scripture#create-a-collection", name: "Multiple Scripture Versions", icon: "help", aliases: ["-Multilingual", "-Multiple translations", "-Multiple Bibles", "-Multiple languages"] },
    { id: "https://presenterbuddy.app/docs/faq#multilingual-songs", name: "Multilingual Song Lyrics", icon: "help", aliases: ["-Multilingual", "-translations", "-lyrics", "-languages", "-translated"] },
    { id: "https://presenterbuddy.app/docs/outputs#how-to-create-lower-third-display-for-a-live-stream", name: "Lower Third Display", icon: "help", aliases: ["-Lower thirds", "-Livestream"] },
    { id: "https://presenterbuddy.app/docs/features#system-requirements", name: "System Requirements", icon: "help", aliases: ["-Specs"] },
    { id: "https://presenterbuddy.app/docs/faq#how-to-import-a-powerpoint-presentation", name: "How to import a PowerPoint presentation", icon: "help", aliases: ["-PowerPoint", "-Keynote", "-slides", "-presentation"] },
    { id: "https://presenterbuddy.app/docs/importing#powerpoint", name: "How to import PowerPoint as text", icon: "help", aliases: ["-PowerPoint", "-slides", "-presentation"] },
    { id: "https://presenterbuddy.app/docs/importing#pdf", name: "How to import a PDF file", icon: "help", aliases: ["-PDF"] },
    { id: "https://presenterbuddy.app/docs/faq#videos-are-muted", name: "Videos are muted", icon: "help", aliases: ["-No audio"] },
    { id: "https://presenterbuddy.app/docs/faq#ccli-integration", name: "CCLI Integration", icon: "help", aliases: ["-SongSelect"] },
    { id: "https://presenterbuddy.app/docs/faq#cloud-sync-between-two-computers", name: "Cloud Sync Between Multiple Computers", icon: "help" },
    { id: "https://presenterbuddy.app/docs/faq#how-to-transfer-the-files-between-computers", name: "Transfer Files Between Computers", icon: "help" },
    { id: "https://presenterbuddy.app/docs/faq#the-app-is-slow", name: "The App is Slow", icon: "help", aliases: ["-Lagging", "-Performance"] },
    { id: "https://presenterbuddy.app/docs/faq#presenterbuddy-keeps-freezing", name: "PresenterBuddy Freezed Suddenly", icon: "help", aliases: ["-Freezing", "-Crash"] },
    // GitHub
    { id: "https://github.com/ChurchApps/PresenterBuddy/issues/693#issuecomment-2255167635", name: "Delete Slide vs Remove Group", icon: "help", aliases: ["-Delete group vs remove slide"] },
    { id: "https://github.com/ChurchApps/PresenterBuddy/issues/1175#issuecomment-2581935274", name: "Custom Bible Version", icon: "help", aliases: ["-Missing scripture", "-Missing Bible"] },
    { id: "https://github.com/ChurchApps/PresenterBuddy/issues/178", name: "Video Loop Behaviour", icon: "help", aliases: ["-Video looping"] },
    { id: "https://github.com/ChurchApps/PresenterBuddy/issues/1123", name: "Unsupported Video Codec", icon: "help", aliases: ["-Video dont play", "-Video not playing", "-MOV", "-MP4"] },
    { id: "https://github.com/ChurchApps/PresenterBuddy/issues/251", name: "Embed PowerPoint/Google Slides", icon: "help", aliases: ["-PowerPoint online", "-Google Presentations"] },
    // Videos (Garry B Jr.)
    { id: "https://youtu.be/v08hZMJuPfY", name: "Find Anything in PresenterBuddy with Quick Search", icon: "youtube" },
    ...
    { id: "https://youtu.be/89skyZYD4jo", name: "Livestream Lower Thirds w/OBS+PresenterBuddy", icon: "youtube" },
    ...
    { id: "https://youtu.be/4dL8p0_OIqY", name: "How to Connect PresenterBuddy to a Screen and OBS", icon: "youtube" },
    ...
    { id: "https://youtu.be/YT5Dil_54Rw", name: "Get MIDI Signals Into PresenterBuddy", icon: "youtube" },
    ...
    { id: "https://youtu.be/Y6Kdmvdc1PM", name: "Customize Companion Buttons for PresenterBuddy & OBS", icon: "youtube" },
    { id: "https://youtu.be/HWN1Mp0bRsM", name: "Use Bitfocus Companion with PresenterBuddy & OBS", icon: "youtube" },
    { id: "https://youtu.be/7_q0zNe7N8o", name: "Best Ways to Use Keynote with PresenterBuddy", icon: "youtube" },
    { id: "https://youtu.be/gM4uqQxHlKg", name: "Setup Audio for Livestream with PresenterBuddy & OBS", icon: "youtube" },
    ...
    { id: "https://youtu.be/3hQDgP4hdZw", name: "How to Add Slide Notes in PresenterBuddy", icon: "youtube" },
    ...
    { id: "https://youtu.be/nNBLCVvf7B4", name: "How to Use Your ATEM Mini with PresenterBuddy", icon: "youtube" },
    ...
    { id: "https://youtu.be/7VGm5tvq_7I", name: "Use Your Yolobox + PresenterBuddy", icon: "youtube" },
    ...
    { id: "https://youtu.be/XUYjbzKHP7U", name: "Zoom with Lower Thirds with PresenterBuddy", icon: "youtube" },
